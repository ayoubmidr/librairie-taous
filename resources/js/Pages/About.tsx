...
export default function About() {
    return (
        <MainLayout title="À propos — Librairie Taous">
            {/* Hero */}
            <section className="bg-gradient-to-r from-[#0f2b1c] to-[#1a4731] py-20">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        {[
                            ...
                            <div key={i} className="p-4">
                                ...
                                <div className="text-3xl font-bold text-[#1a4731] font-serif">{stat.value}</div>
            ...
            <section className="py-16">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="prose prose-stone max-w-none">
                        <h2 className="text-3xl font-serif font-bold text-[#0f2b1c] mb-6">Notre mission</h2>
                        ...
                        <h2 className="text-3xl font-serif font-bold text-[#0f2b1c] mt-12 mb-6">Les Éditions Taous</h2>
                        <p className="text-stone-600 leading-relaxed mb-6">
                            En parallèle de notre activité de librairie, nous avons fondé les <strong className="text-[#1a4731]">Éditions Taous</strong> — notre propre maison d'édition islamique.
                        </p>
                        <p className="text-stone-600 leading-relaxed mb-6">
            ...
            <section className="py-16 bg-[#fdf8f0]">
                <div className="max-w-5xl mx-auto px-4">
                    <h2 className="text-3xl font-serif font-bold text-[#0f2b1c] text-center mb-12">Nos engagements</h2>
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="bg-white rounded-2xl p-8 text-center shadow-sm">
                                <div className="flex justify-center text-[#1a4731] mb-4">{val.icon}</div>
                                <h3 className="font-serif font-bold text-xl text-[#0f2b1c] mb-3">{val.title}</h3>
            ...
            <section className="py-16">
                <div className="max-w-3xl mx-auto px-4 text-center">
                    <h2 className="text-3xl font-serif font-bold text-[#0f2b1c] mb-4">Rejoignez notre communauté</h2>
                    <p className="text-stone-600 mb-8">Découvrez notre catalogue de plus de 1000 références islamiques</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href={route('shop.index')} className="inline-flex items-center justify-center gap-2 bg-[#1a4731] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#2d7a52] transition-colors">
                            Parcourir le catalogue
                        </Link>
                        <Link href={route('contact')} className="inline-flex items-center justify-center gap-2 border-2 border-[#1a4731] text-[#1a4731] px-8 py-4 rounded-lg font-semibold hover:bg-[#1a4731] hover:text-white transition-colors">
                            Nous contacter
                        </Link>
                    </div>
                </div>
