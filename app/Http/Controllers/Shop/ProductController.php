    ...
    public function show(Product $product)
    {
        ...
        return Inertia::render('Shop/Product', [
            'product' => [
                ...
                'reseller_price' => $product->reseller_price !== null ? (float) $product->reseller_price : null,
                'wholesaler_price' => $product->wholesaler_price !== null ? (float) $product->wholesaler_price : null,
                'stock' => $product->stock,
                'type' => $product->type,
